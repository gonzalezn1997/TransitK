...
public class Trips implements Subject {
     ...
     * @return The Trips object containing a collection of Trip on a specified route.
     * @author Alexander Gnabask
     */
    ...
    /**
     * Adds an observer to the Trips
     *
     * @param observer An observer to the Trips.
     * @author Alexander Gnabask
     */
    @Override
    ...
    public File export(File file) {
        try {
            ...
            System.err.println("Could not export the Trips file; File Malformed.");
        }
        return file;
    }
     ...
     * @author Alexander Gnabask
     */
    public LinkedHashSet<String> importFile(File file) {
        try {
                ...
                if (checkAttributes(attributes)) {
                    while (in.hasNextLine()) {
                        ...
                        if (idChecker(routeId) && idChecker(serviceId) && idChecker(tripId)) {
                            ...
                            System.err.println("Could not import Trip; Trip Attribute Malformed");
                        }
                    }
                    return tripIds;
                }
            ...
            System.err.println("Could not import Trips file: File Malformed");
        }
        return null;
    }
    ...
    public void updateTrips() {
        ...
        System.out.println("Before: " + dateFormat.format(dateBefore));
        colOfTrips.parallelStream().forEach(Trip::updateTrip);
        Date dateAfter = new Date();
        System.out.println("After: " + dateFormat.format(dateAfter));
       /* for (Trip t: colOfTrips) {
            t.updateTrip();
            System.out.println("Updated Trip: " + i++);
        } */
        System.out.println("Updating Trips complete");
    }
